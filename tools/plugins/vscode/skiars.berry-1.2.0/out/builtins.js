...
exports.KEYWORDS = exports.MODULE_NAMES = exports.MAP_METHOD_MAP = exports.LIST_METHOD_MAP = exports.STRING_METHOD_MAP = exports.INTROSPECT_FUNCTION_MAP = exports.DEBUG_FUNCTION_MAP = exports.OS_FUNCTION_MAP = exports.JSON_FUNCTION_MAP = exports.MATH_FUNCTION_MAP = exports.GLOBAL_FUNCTION_MAP = exports.INTROSPECT_FUNCTIONS = exports.DEBUG_FUNCTIONS = exports.OS_FUNCTIONS = exports.JSON_FUNCTIONS = exports.MATH_CONSTANTS = exports.MATH_FUNCTIONS = exports.MAP_METHODS = exports.LIST_METHODS = exports.STRING_METHODS = exports.CONSTANT_DOCS = exports.GLOBAL_FUNCTIONS = void 0;
exports.buildFunctionMap = buildFunctionMap;
// ---------------------------------------------------------------------------
// Global functions
// ---------------------------------------------------------------------------
exports.GLOBAL_FUNCTIONS = [
    {
        name: 'assert',
    ...
    },
    {
        ...
        documentation: 'Reads a line from standard input and returns it as a string. ' +
    ...
    },
    {
        ...
        documentation: 'Compiles the Berry source `code` string and returns a closure. ' +
    ...
    },
    {
        ...
        documentation: 'Creates and returns a new empty module object, or returns the existing module ' +
    ...
    },
    {
        ...
        documentation: 'Returns the number of elements in `value`. Works for strings (byte count), ' +
    ...
    },
    {
        ...
        documentation: 'Returns a formatted string. The format string uses `printf`-style placeholders: ' +
    ...
    },
    {
        ...
        documentation: 'Returns an iterator for `value`. For objects that support it (list, map, range, ' +
...
exports.STRING_METHODS = [
    ...
    },
    {
        ...
        documentation: 'Returns the index of the first occurrence of `sub`, or `-1` if not found. ' +
...
// JSON module
// ---------------------------------------------------------------------------
exports.JSON_FUNCTIONS = [
    {
        name: 'load',
        signature: 'json.load(text)',
        documentation: 'Parses the JSON string `text` and returns the equivalent Berry value ' +
...
exports.GLOBAL_FUNCTION_MAP = buildFunctionMap(exports.GLOBAL_FUNCTIONS);
exports.MATH_FUNCTION_MAP = buildFunctionMap(exports.MATH_FUNCTIONS);
exports.JSON_FUNCTION_MAP = buildFunctionMap(exports.JSON_FUNCTIONS);
exports.OS_FUNCTION_MAP = buildFunctionMap(exports.OS_FUNCTIONS);
exports.DEBUG_FUNCTION_MAP = buildFunctionMap(exports.DEBUG_FUNCTIONS);
exports.INTROSPECT_FUNCTION_MAP = buildFunctionMap(exports.INTROSPECT_FUNCTIONS);
exports.STRING_METHOD_MAP = buildFunctionMap(exports.STRING_METHODS);
exports.LIST_METHOD_MAP = buildFunctionMap(exports.LIST_METHODS);
exports.MAP_METHOD_MAP = buildFunctionMap(exports.MAP_METHODS);
/** All known importable module names. */
exports.MODULE_NAMES = ['math', 'json', 'os', 'debug', 'introspect', 'global', 'solidify', 'strict', 'sys', 'string', 'path'];
/** All Berry keywords. */
exports.KEYWORDS = [
